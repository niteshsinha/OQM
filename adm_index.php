...
return escape(str).replace(/\+/g,'%2B').replace(/%20/g, '+').replace(/\*/g, '%2A').replace(/\//g, '%2F').replace(/@/g, '%40');
			   ...
			   {			            
					...
					else if(fn_name=='show_addDomain')
					{
...
<table style="text-align:center;">
	<tr>
    	<td>
        	<input type="button" class="button blue medium" id="btnadd" name="btnadd" value="Add Content" onClick="ajax_call('showadd')"/>
        </td>
    	<td>
        	<input type="button" class="button green medium" id="btnmod" name="btnmod" value="Modify Content" onClick="ajax_call('showmod')"/>
        </td>
        <td>
        	<input type="button" class="button blue medium2" value="Display Reports" onClick="ajax_call('showrep')"/>
        </td>
    </tr>
</table>	
                                
<table id="addcontent" style="text-align:center;">
	<tr>
    	<td>
        	<input type="button" class="button blue medium" value="Add Category" onClick="ajax_call('show_addDomain')"/>
        </td>
        <td>
        	<input type="button" class="button blue medium" value="Add Test" onClick="addTest('*null*','*null*')"/>
        </td>
        <td>
        	<input type="button" class="button blue medium" value="Add Questions" onClick="addQuesDirectly()"/>
        </td>
    </tr>
</table>
<table id="modcontent" style="display:none;text-align:center;">
	<tr>
    	<td>
        	<input type="button" class="button green medium" value="Edit/Delete Category" onClick="ajax_call('show_modDomain')"/>
        </td>
        <td>
        	<input type="button" class="button green medium" value="Edit/Delete Test" onClick="addTest('*null*','*null*')"/>
        </td>
        <td> 
        	<input type="button" class="button green medium" value="Edit/Delete Question" onClick="addQuesDirectly()"/>
        </td>
    </tr>
</table>
